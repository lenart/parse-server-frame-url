...
//         write permissions.
var specialKeysForUpdate = ['_hashed_password', '_perishable_token', '_email_verify_token', '_email_verify_token_expires_at', '_account_lockout_expires_at', '_failed_login_count', '_perishable_token_expires_at', '_password_changed_at'];
...
DatabaseController.prototype.deleteSchema = function (className) {
  ...
  return this.loadSchema(true).then(function (schemaController) {
    ...
    return _this11.collectionExists(className).then(function (exist) {
