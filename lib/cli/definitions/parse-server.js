...
}, _defineProperty(_appId$masterKey$port, "liveQuery", {
  help: "parse-server's LiveQuery configuration object",
  action: _parsers.objectParser
}), _defineProperty(_appId$masterKey$port, "liveQuery.classNames", {
  help: "parse-server's LiveQuery classNames",
  action: _parsers.arrayParser
}), _defineProperty(_appId$masterKey$port, "liveQuery.redisURL", {
  help: "parse-server's LiveQuery redisURL"
}), _defineProperty(_appId$masterKey$port, "startLiveQueryServer", {
  help: "Starts the liveQuery server",
  action: _parsers.booleanParser
}), _defineProperty(_appId$masterKey$port, "liveQueryPort", {
  help: 'Specific port to start the live query server',
  action: (0, _parsers.numberParser)("liveQueryPort")
}), _defineProperty(_appId$masterKey$port, "liveQueryServerOptions", {
  help: "Live query server configuration options (will start the liveQuery server)",
  action: _parsers.objectParser
}), _appId$masterKey$port);